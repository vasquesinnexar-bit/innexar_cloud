...
export function ProjectsSection({ compact = false }: { compact?: boolean }) {
  return <section className="relative overflow-hidden bg-[#081321] py-20 md:py-28"><div aria-hidden className="pointer-events-none absolute right-0 top-0 h-96 w-96 rounded-full bg-cyan-400/[.07] blur-[120px]" /><div className="relative mx-auto max-w-[1180px] px-6 xl:px-8"><div className="max-w-2xl"><p className="text-xs font-bold uppercase tracking-[.16em] text-cyan-300">Projetos em operação</p>{compact ? (
          <h1 className="mt-4 font-[family-name:var(--font-syne)] text-3xl font-bold tracking-[-.03em] text-white md:text-5xl">Tecnologia construída para resolver contextos reais.</h1>
        ) : (
          <h2 className="mt-4 font-[family-name:var(--font-syne)] text-3xl font-bold tracking-[-.03em] text-white md:text-5xl">Tecnologia construída para resolver contextos reais.</h2>
