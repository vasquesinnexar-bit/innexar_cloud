...
from app.core.security import create_token_customer, decode_token_customer, verify_password
...
async def check_email(
    ...
    if cu:
        ...
        return CheckEmailResponse(exists=True, customer_name=cust.name if cust else None)
